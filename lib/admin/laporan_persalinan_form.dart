...
class LaporanPersalinanFormDialog extends StatefulWidget {
  final Map<String, dynamic>? examinationData;
  final PersalinanModel? persalinanData;

  const LaporanPersalinanFormDialog({
    super.key,
  ...
  @override
  State<LaporanPersalinanFormDialog> createState() =>
      _LaporanPersalinanFormDialogState();
}

class _LaporanPersalinanFormDialogState
    extends State<LaporanPersalinanFormDialog> {
          ...
          SnackBar(
            content: Text(
              widget.persalinanData == null
                  ? 'Laporan persalinan berhasil disimpan'
                  : 'Laporan persalinan berhasil diperbarui',
            ),
